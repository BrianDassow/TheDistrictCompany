...
\begin{columns}
\column{\textwidth}
\includegraphics[width=10.5cm,height=2.5cm]{scope}
\setbeamertemplate{itemize items}[circle]
\begin{itemize}
\item Helps to better understand why certain categories are doing well
\item Can see what’s causing correlations
\item Suggest improvements to the company about categories that aren’t doing as well
\end{itemize}
